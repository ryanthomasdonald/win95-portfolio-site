        ...
        <Rnd
            ...
            <div className="window-content">
                ...
                <div className="col-11">
                    <img className="title-bar-left draggable" src="img/quake-readme-title-bar-left.png" />
                </div>
                <div className="col-1 d-flex justify-content-end">
                    <img className="title-bar-right" src="img/window-header-title-bar-right.png" useMap="#closeQuakeReadme" />
                    <map name="closeQuakeReadme">
                        <area onClick={(e) => handleCloseQuakeReadme(e)} shape="rect" coords="68,2,100,32" href="#" />
                    </map>
                </div>
                </div>
