...
import {
  ...
  updateShowLarry,
  updateShowDoom,
  updateShowDoomReadme,
  updateShowQuake,
  updateShowQuakeReadme,
  updateShowTodo,
      ...
      <div className="window-content">
        ...
        <div className="window-body-border">
          <div className="row gx-0">
            <div
              className="col web-work-icon-top"
              onDoubleClick={(e) => handleVerseDoubleClick(e)}
            >
            ...
            <div
              className="col web-work-icon-top"
              onDoubleClick={(e) => handleKartDoubleClick(e)}
            >
              <img src="../img/desktop-icons/folder.png" width="64px" />
            ...
            <div
              className="col web-work-icon-top"
              onDoubleClick={(e) => handleBirDBDoubleClick(e)}
            >
              <img src="../img/desktop-icons/folder.png" width="64px" />
          ...
          <div className="row gx-0">
            <div
              className="col web-work-icon"
              onDoubleClick={(e) => handleWBDoubleClick(e)}
            >
              <img src="../img/desktop-icons/folder.png" width="64px" />
            ...
            <div
              className="col web-work-icon"
              onDoubleClick={(e) => handleBJ95DoubleClick(e)}
            >
              <img src="../img/desktop-icons/folder.png" width="64px" />
            ...
            <div
              className="col web-work-icon"
              onDoubleClick={(e) => handleLarryDoubleClick(e)}
            >
              <img src="../img/desktop-icons/folder.png" width="64px" />
          ...
          <div className="row gx-0">
            <div
              className="col web-work-icon"
              onDoubleClick={(e) => handleDoomDoubleClick(e)}
            >
            ...
            <div
              className="col web-work-icon-quake"
              onDoubleClick={(e) => handleQuakeDoubleClick(e)}
            >
            ...
            >
              ...
              <div className="web-work-todo-text no-text-select">Todo.txt</div>
            </div>
          </div>
        </div>
      </div>
