      ...
      <div className="window-content">
        <div className="row title-bar-bg-blue gx-0">
          <div className="col-11 draggable">
            <img
              ...
              alt="title bar"
              src="img/lets-chat-title-bar-left.png"
            />
          </div>
        ...
        <div className="window-body-border">
          <p className="p-without-img-above">
            I'm excited to continue this new chapter in my life and if I've
            learned ANYTHING from my years as a professional musician, it's that
            having a healthy network is a must when searching for new
            opportunities.
            <br />
            <br />
            ...
            <div className="row gx-0">
              <div className="col-6 d-flex justify-content-end px-3 py-4">
                <a href="https://github.com/ryanthomasdonald" target="blank">
                  <img src="img/github-logo.png" alt="GitHub" width="130px" />
                </a>
              </div>
              <div className="col-6 d-flex justify-content-start px-3 py-4">
                <a
                  href="https://www.linkedin.com/in/ryan-donald-96351221a/"
                  target="blank"
                >
                  <img src="img/li-logo.png" alt="LinkedIn" width="130px" />
                </a>
              </div>
            </div>
            <div className="row gx-0">
              <div className="col-6 d-flex justify-content-end px-3">
                <a href="mailto:ryanthomasdonald@gmail.com" target="blank">
                  <img src="img/gmail-logo.png" alt="Gmail" width="130px" />
                </a>
              </div>
              <div className="col-6 d-flex justify-content-start px-4">
                <a
                  className="resume-align"
                  href="files/ryan-thomas-donald-resume-2023.pdf"
                  target="blank"
                >
                  <img
                    width="104px"
                    src={resumeImg}
                    onMouseOver={() => ShowResumeLetters()}
                    onMouseOut={() => HideResumeLetters()}
                    alt="resume"
                  />
                </a>
              </div>
