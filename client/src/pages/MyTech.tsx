      ...
      <div className="window-content">
        <div className="row title-bar-bg-blue gx-0">
          <div className="col-11 draggable">
            <img
              ...
              src="img/my-tech-title-bar-left.png"
            />
          </div>
        ...
        <div className="window-body-border">
          <p className="p-without-img-above">
            Below, you'll find a list of the technologies/applications with
            which I have experience. A good number are from the bootcamp that I
            recently attended with others coming from years of bouncing between
            ...
            <br />
            HTML, CSS, Type/JavaScript, Node.js, Bootstrap, Python, Express,
            React, Redux, Chart.js, Sequelize, PostgresSQL, Git, VSCode,
            ...
            <br />
            Avid Pro Tools, Adobe Photoshop, Adobe Premiere, HandBrake (converts
            legacy video codecs for use in modern NLE environments)
            <br />
            <div className="row gx-0">
              <div className="col d-flex justify-content-center">
