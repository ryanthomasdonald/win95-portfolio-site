      ...
      <div className="window-content">
        <div className="row title-bar-bg-blue gx-0">
          <div className="col-11 draggable">
            <img
              ...
              src="img/my-music-title-bar-left.png"
            />
          </div>
        ...
        <div className="window-body-border">
          <p className="p-without-img-above">
            No webpage about music is complete without a diatribe outlining the
            pros and cons of streaming services, but as a humble bassist, I'll
            spare you that soapbox for now.
            <br />
            <br />
            ...
            <div className="row gx-0">
              <div className="col d-flex justify-content-center">
                <a
                  href="https://open.spotify.com/artist/4wzILxEdnni4pGRUyJIVAp?si=5aGMnCRYSQucJCb_GDLYrA&dl_branch=1"
                  target="blank"
                >
                  <img
