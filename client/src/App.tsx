...
import {
  ...
  selectShowDoom,
  selectShowQuake,
  selectShowDoomReadme,
  selectShowQuakeReadme,
  selectShowTodo,
...
function App(): JSX.Element {
  ...
  return (
    <>
      <div>
        <img
          className="story-icon no-text-select"
          src="img/desktop-icons/my-story-no-text.png"
          onDoubleClick={(e) => handleStoryDoubleClick(e)}
        />
        <div
          className="story-icon-text no-text-select"
          onDoubleClick={(e) => handleStoryDoubleClick(e)}
        >
          My Story
        </div>
      ...
      <div>
        <img
          className="music-icon no-text-select"
          src="img/desktop-icons/my-music-no-text.png"
          onDoubleClick={(e) => handleMusicDoubleClick(e)}
        />
        <div
          className="music-icon-text no-text-select"
          onDoubleClick={(e) => handleMusicDoubleClick(e)}
        >
          My Music
        </div>
      ...
      <div>
        <img
          className="tech-icon no-text-select"
          src="img/desktop-icons/my-tech-no-text.png"
          onDoubleClick={(e) => handleTechDoubleClick(e)}
        />
        <div
          className="tech-icon-text no-text-select"
          onDoubleClick={(e) => handleTechDoubleClick(e)}
        >
          My Tech
        </div>
      ...
      <div>
        <img
          className="web-icon no-text-select"
          src="img/desktop-icons/web-work-no-text.png"
          onDoubleClick={(e) => handleWebDoubleClick(e)}
        />
        <div
          className="web-icon-text no-text-select"
          onDoubleClick={(e) => handleWebDoubleClick(e)}
        >
          Web Work
        </div>
      ...
      <div>
        <img
          className="chat-icon no-text-select"
          src="img/desktop-icons/lets-chat-no-text.png"
          onDoubleClick={(e) => handleChatDoubleClick(e)}
        />
        <div
          className="chat-icon-text no-text-select"
          onDoubleClick={(e) => handleChatDoubleClick(e)}
        >
          Let's Chat!
        </div>
