    ...
    <>
      <div className="table">
        <div className="player">
          <div className="flex-container" style="height:233px">
            ...
            <div
              ...
              style="width:600px; font-size:210px; text-align:center"
              id="message"
            ></div>
            <div style="width:300px">
              <div
                id="p-wins"
                className="windows-font text-white"
                style="margin-left:192px; margin-top:98px; font-size:30px"
              >
                0
              </div>
              <div
                id="d-wins"
                className="windows-font text-white"
                style="margin-left:192px; margin-top:42px; font-size:30px"
              >
                0
              </div>
            </div>
          ...
          <label
            ...
            className="player-name windows-font text-white"
          >
            Dealer's Hand:
          ...
          <div
            id="dealer-hand"
            style="height:225px; margin-left:32px"
            className="hand"
          >
            <span>
        ...
        <div className="flex-container">
          <div
            className="buttons button-box"
            style="margin-left:42px; margin-top:12px;"
          >
            <button id="new-hand-button" className="windows-font" type="button">
              New Hand
            </button>
            <button id="flip-button" className="windows-font" type="button">
              Flip Cards
            </button>
            <button id="hit-button" className="windows-font" type="button">
              Hit Me!
            </button>
            <button id="stand-button" className="windows-font" type="button">
              Stand
            </button>
          </div>
          <div className="score-box">
            <div
              id="player-total"
              className="text-white windows-font"
              style="margin-left:150px; font-size:30px; margin-top:16px"
            >
              0
            </div>
          </div>
