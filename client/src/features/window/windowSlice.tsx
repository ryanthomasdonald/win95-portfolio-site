...
export const selectShowDoomReadme = (state: RootState) =>
  state.window.showDoomReadme;
export const selectShowQuakeReadme = (state: RootState) =>
  state.window.showQuakeReadme;
